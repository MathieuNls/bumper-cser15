...
\title[BUMPER]{BUMPER: Bug Metarepository Search Engine for Developers and Researchers} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\date{November 1st, 2015} % Date, can be changed to a custom date
